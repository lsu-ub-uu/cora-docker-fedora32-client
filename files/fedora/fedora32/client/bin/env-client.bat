...
if exist "%FEDORA_HOME%\client\fedora-client-3.2.1.jar" goto clientJarFound
echo ERROR: fedora-client-3.2.1.jar not found in %FEDORA_HOME%\client
exit /B 1
:clientJarFound
...
set CP="%FEDORA_HOME%\client;%FEDORA_HOME%\client\fedora-client-3.2.1.jar"
