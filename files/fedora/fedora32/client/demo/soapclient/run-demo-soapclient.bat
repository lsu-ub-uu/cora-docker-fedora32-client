...
if not exist "%FEDORA_HOME%\client\fedora-client-3.2.1.jar" goto clientNotFound
...
echo Client cannot be found at %FEDORA_HOME%\client\fedora-client-3.2.1.jar
goto end
